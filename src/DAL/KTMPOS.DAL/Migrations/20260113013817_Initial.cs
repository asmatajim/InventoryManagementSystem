        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_AspNetRoles_NormalizedName", "[NormalizedName]=UPPER(Name)");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_AspNetUsers_NormalizedEmail", "[NormalizedEmail]=UPPER(Email)");
                    table.CheckConstraint("CK_AspNetUsers_NormalizedUserName", "[NormalizedUserName]=UPPER(UserName)");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 0, "c4e1cf62-ba8a-4a18-9a8d-75d1d55b36d0", new DateTime(2026, 1, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), "sbhattarai@q.com", true, false, null, "SBHATTARAI@Q.COM", "SUMIT", "AQAAAAIAAYagAAAAEMCfVPeG+3aPUfRQdkhuRBFQxJWGUOEKaxWiuh6fYQ5nWaai6V76F2zrT9BOY2qNDA==", null, false, "03712bef-c203-4a63-9744-6f7ba748ee24", false, "sumit" });
