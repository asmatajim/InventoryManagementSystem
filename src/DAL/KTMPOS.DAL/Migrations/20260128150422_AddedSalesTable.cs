        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Sales_GrandTotal", "[GrandTotal] > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_SalesDetail_Qty", "[Qty] > 0");
                    table.CheckConstraint("CK_SalesDetail_SubTotal", "[SubTotal] > 0 AND ([SubTotal] = [Qty] * [UnitPrice])");
                    table.CheckConstraint("CK_SalesDetail_UnitPrice", "[UnitPrice] > 0");
                    table.ForeignKey(
